...
def create_company():
    ...
    "overview_company" : "nfosys begins its on-campus recruitments from early September. During July and August, they continue with their off-campus activities. If you fail in the first attempt, you can retake the exam after one month’s time. You can reappear for the certification examination after a month. However, upon two unsuccessful attempts, you will need to wait for 3 months to reappear for the next attempt. The level of exam is moderate to difficult.",
    "eligibility_criteria":"Eligibility Criteria If you are dreaming of working with Infosys, you are at the right place. Infosys is one of the top recruiters in India in the field of information technology, therefore it is imperative for the aspirants to know the company's eligibility criteria. Read on to find out Infosys selection policies, graduation criteria, academic criteria and documents needed for applying for the positions of Systems Engineer Trainee / Software Engineer trainee at Infosys. Infosys Off Campus Recruitment has same eligibility criteria.",
